...
const quizData = [
  ...
  {
    questionText:
      "In JavaScript a _____ function can be defined as a function passed into another function as a parameter.",
    options: ["A. call front", "B. roll back", "C. roll front", "D. call back"],
    answer: "D. call back",
  },
  {
...
function checkAnswer(eventObject) {
  ...
  if (optionIsCorrect(optionButton)) {
    ...
    finalText.setAttribute(
      "style",
      "color: lime; font-weight: bold; text-align: center"
    );
